...
export type Mutation = {
  ...
  createListing?: Maybe<CreateListingResponse>;
};
...
export type MutationResolvers<ContextType = DataSourceContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  createListing?: Resolver<Maybe<ResolversTypes['CreateListingResponse']>, ParentType, ContextType, RequireFields<MutationCreateListingArgs, 'input'>>;
};
